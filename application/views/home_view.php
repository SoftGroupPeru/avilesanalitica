        ...
        <div class="tp-banner">
            <ul>
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 1">
                    <!-- MAIN IMAGE -->
                    <img src="<?php echo $url;?>assets/img/1.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 2">
                    <!-- MAIN IMAGE -->
                    <img src="<?php echo $url;?>assets/img/5.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 3">
                    <!-- MAIN IMAGE -->
                    <img src="<?php echo $url;?>assets/img/3.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="right top" data-bgrepeat="no-repeat">
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 4">
                    <!-- MAIN IMAGE -->
                    <img src="<?php echo $url;?>assets/img/2.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Slide 5">
                    <!-- MAIN IMAGE -->
                    <img src="<?php echo $url;?>assets/img/4.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="right top" data-bgrepeat="no-repeat">
...
<div class="container content-md">
        ...
        <div class="row margin-bottom-50">
            <div class="col-md-4 md-margin-bottom-30">
                <div class="overflow-h">
                    <a class="illustration-v3 aviles-home1" href="#">
                        <span class="illustration-bg">
                            <span class="illustration-ads">
                                <span class="illustration-v3-category">
                                    <span class="product-category">Elga</span>
                                    <span class="product-amount">56 Productos</span>
                                </span>
                            </span>
                        </span>
                    </a>
            ...
            <div class="col-md-4 md-margin-bottom-30">
                <div class="overflow-h">
                    <a class="illustration-v3 aviles-home2" href="#">
                        <span class="illustration-bg">
                            <span class="illustration-ads">
                                <span class="illustration-v3-category">
                                    <span class="product-category">ENVEX</span>
                                    <span class="product-amount">56 Productos</span>
                                </span>
                            </span>
                        </span>
            ...
            <div class="col-md-4">
                <div class="overflow-h">
                    <a class="illustration-v3 aviles-home3" href="#">
                        <span class="illustration-bg">
                            <span class="illustration-ads">
                                <span class="illustration-v3-category">
                                    <span class="product-category">KODO</span>
                                    <span class="product-amount">56 Productos</span>
                                </span>
                            </span>
                        </span>
        ...
        <div class="row margin-bottom-50">
            <div class="col-md-4 md-margin-bottom-30">
                <div class="overflow-h">
                    <a class="illustration-v3 aviles-home4" href="#">
                        <span class="illustration-bg">
                            <span class="illustration-ads">
                                <span class="illustration-v3-category">
                                    <span class="product-category">CETAC</span>
                                    <span class="product-amount">56 Productos</span>
                                </span>
                            </span>
                        </span>
            ...
            <div class="col-md-4 md-margin-bottom-30">
                <div class="overflow-h">
                    <a class="illustration-v3 aviles-home5" href="#">
                        <span class="illustration-bg">
                            <span class="illustration-ads">
                                <span class="illustration-v3-category">
                                    <span class="product-category">EBERBACH</span>
                                    <span class="product-amount">56 Productos</span>
                                </span>
                            </span>
                        </span>
            ...
            <div class="col-md-4">
                <div class="overflow-h">
                    <a class="illustration-v3 aviles-home6" href="#">
                        <span class="illustration-bg">
                            <span class="illustration-ads">
                                <span class="illustration-v3-category">
                                    <span class="product-category">PARKER</span>
                                    <span class="product-amount">56 Productos</span>
                                </span>
                            </span>
                        </span>
        ...
        <div class="row margin-bottom-50">
            <div class="col-md-4 md-margin-bottom-30">
                <div class="overflow-h">
                    <a class="illustration-v3 aviles-home7" href="#">
                        <span class="illustration-bg">
                            <span class="illustration-ads">
                                <span class="illustration-v3-category">
                                    <span class="product-category">HERAEUS</span>
                                    <span class="product-amount">56 Productos</span>
                                </span>
                            </span>
                        </span>
            ...
            <div class="col-md-4 md-margin-bottom-30">
                <div class="overflow-h">
                    <a class="illustration-v3 aviles-home8" href="#">
                        <span class="illustration-bg">
                            <span class="illustration-ads">
                                <span class="illustration-v3-category">
                                    <span class="product-category">FISHER SCIENTIFIC</span>
                                    <span class="product-amount">56 Productos</span>
                                </span>
                            </span>
                        </span>
            ...
            <div class="col-md-4">
                <div class="overflow-h">
                    <a class="illustration-v3 aviles-home9" href="#">
                        <span class="illustration-bg">
                            <span class="illustration-ads">
                                <span class="illustration-v3-category">
                                    <span class="product-category">SERVICIO TECNICO</span>
                                </span>
                            </span>
                        </span>
                    </a>
            ...
            <ul class="list-inline owl-slider">
                <li class="item">
                    <div class="product-img">
                        <a href="shop-ui-inner.html"><img class="full-width img-responsive" src="<?php echo $url;?>assets/img/blog/09.jpg" alt=""></a>
                ...
                <li class="item">
                    <div class="product-img">
                        <a href="shop-ui-inner.html"><img class="full-width img-responsive" src="<?php echo $url;?>assets/img/blog/26.jpg" alt=""></a>
                        <a class="product-review" href="shop-ui-inner.html">Quick review</a>
                        <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                    </div>
                    <div class="product-description product-description-brd">
                ...
                <li class="item">
                    <div class="product-img">
                        <a href="shop-ui-inner.html"><img class="full-width img-responsive" src="<?php echo $url;?>assets/img/blog/11.jpg" alt=""></a>
                        <a class="product-review" href="shop-ui-inner.html">Quick review</a>
                        <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                ...
                <li class="item">
                    <div class="product-img">
                        <a href="shop-ui-inner.html"><img class="full-width img-responsive" src="<?php echo $url;?>assets/img/blog/12.jpg" alt=""></a>
                        <a class="product-review" href="shop-ui-inner.html">Quick review</a>
                        <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                ...
                <li class="item">
                    <div class="product-img">
                        <a href="shop-ui-inner.html"><img class="full-width img-responsive" src="<?php echo $url;?>assets/img/blog/10.jpg" alt=""></a>
                        <a class="product-review" href="shop-ui-inner.html">Quick review</a>
                        <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                    </div>
                    <div class="product-description product-description-brd">
        ...
        <div class="row illustration-v2">
            <div class="col-md-3 col-sm-6 md-margin-bottom-30">
                <div class="product-img">
                    <a href="shop-ui-inner.html"><img class="full-width img-responsive" src="<?php echo $url;?>assets/img/blog/25.jpg" alt=""></a>
                    <a class="product-review" href="shop-ui-inner.html">Quick review</a>
                    <a class="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                </div>
                <div class="product-description product-description-brd">
        ...
        <div class="row illustration-v4 margin-bottom-40">
            <div class="col-md-4">
                ...
                <div class="thumb-product">
                    <img class="thumb-product-img" src="<?php echo $url;?>assets/img/thumb/08.jpg" alt="">
                ...
                <div class="thumb-product">
                    <img class="thumb-product-img" src="<?php echo $url;?>assets/img/thumb/09.jpg" alt="">
                    <div class="thumb-product-in">
                        <h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
                        <span class="thumb-product-type">Footwear - Oxfords</span>
                    </div>
                ...
                <div class="thumb-product">
                    <img class="thumb-product-img" src="<?php echo $url;?>assets/img/thumb/03.jpg" alt="">
                    <div class="thumb-product-in">
                        <h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
                        <span class="thumb-product-type">Footwear - Oxfords</span>
                    </div>
            ...
            <div class="col-md-4">
                ...
                <div class="thumb-product">
                    <img class="thumb-product-img" src="<?php echo $url;?>assets/img/thumb/02.jpg" alt="">
                    <div class="thumb-product-in">
                        <h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
                        <span class="thumb-product-type">Footwear - Oxfords</span>
                    </div>
                ...
                <div class="thumb-product">
                    <img class="thumb-product-img" src="<?php echo $url;?>assets/img/thumb/10.jpg" alt="">
                    <div class="thumb-product-in">
                        <h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
                        <span class="thumb-product-type">Footwear - Oxfords</span>
                    </div>
                ...
                <div class="thumb-product">
                    <img class="thumb-product-img" src="<?php echo $url;?>assets/img/thumb/06.jpg" alt="">
                    <div class="thumb-product-in">
                        <h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
                        <span class="thumb-product-type">Footwear - Oxfords</span>
                    </div>
            ...
            <div class="col-md-4 padding">
                ...
                <div class="thumb-product">
                    <img class="thumb-product-img" src="<?php echo $url;?>assets/img/thumb/07.jpg" alt="">
                    <div class="thumb-product-in">
                        <h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
                        <span class="thumb-product-type">Footwear - Oxfords</span>
                    </div>
                ...
                <div class="thumb-product">
                    <img class="thumb-product-img" src="<?php echo $url;?>assets/img/thumb/04.jpg" alt="">
                    <div class="thumb-product-in">
                        <h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
                        <span class="thumb-product-type">Footwear - Oxfords</span>
                    </div>
                ...
                <div class="thumb-product">
                    <img class="thumb-product-img" src="<?php echo $url;?>assets/img/thumb/05.jpg" alt="">
                    <div class="thumb-product-in">
                        <h4><a href="shop-ui-inner.html">Yuketen</a> – <a href="shop-ui-inner.html">Derby Shoe</a></h4>
                        <span class="thumb-product-type">Footwear - Oxfords</span>
                    </div>
    ...
    <div class="container content">
        ...
        <ul class="list-inline owl-slider-v2">
            <li class="item first-child">
                <img src="<?php echo $url;?>assets/img/clients/07.png" alt="">
            </li>
            <li class="item">
                <img src="<?php echo $url;?>assets/img/clients/08.png" alt="">
            </li>
            <li class="item">
                <img src="<?php echo $url;?>assets/img/clients/10.png" alt="">
            </li>
            <li class="item">
                <img src="<?php echo $url;?>assets/img/clients/11.png" alt="">
            </li>
            <li class="item">
                <img src="<?php echo $url;?>assets/img/clients/09.png" alt="">
            </li>
            <li class="item">
                <img src="<?php echo $url;?>assets/img/clients/12.png" alt="">
            </li>
            <li class="item">
                <img src="<?php echo $url;?>assets/img/clients/07.png" alt="">
            </li>
